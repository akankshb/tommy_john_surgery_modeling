...
plt.plot()
Healthy_SPL_percentage_df[0].hist(alpha= 0.7, label = 'Healthy Pitcher Splitter Percentage', density = True)
Injured_SPL_percentage_df[0].hist(alpha = 0.7, label = 'Tommy John Pitcher Splitter Percentage', density = True)
plt.legend()
plt.show()
